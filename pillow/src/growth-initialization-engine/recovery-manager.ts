/** X1-12 — Growth Initialization Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: GrowthInitializationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendGieLog({
      event: "growth_failures",
      level: "warn",
    ...
    appendGieLog({
      ...
      level: "info",
      details: `Growth Initialization Engine recovery attempt ${this.recoveryAttempts}`,
    });

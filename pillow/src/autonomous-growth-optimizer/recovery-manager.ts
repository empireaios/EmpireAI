/** X3-15 — Automatic autonomous growth optimizer recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: AutonomousGrowthOptimizerConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendAgoLog({
      event: "autonomous_growth_failure",
      level: "warn",

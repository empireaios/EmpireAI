...
const INTENT_PATTERNS: Array<{ task: ContextTask; patterns: RegExp[] }> = [
  {
    ...
    patterns: [
      ...
      /continuously evolve/i,
      /continuous optimisation/i,
      /continuous optimization/i,
      /improvement backlog/i,
      /evolution engine/i,
      /never stagnat/i,
      /due diligence cycle/i,
      /continuous due diligence/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /empire commander/i,
      /executive commander/i,
      /overall empire health/i,
      /empire health/i,
      /strategic plan/i,
      /strategic priorit/i,
      /cross-domain/i,
      /prioriti[sz]e empire/i,
      /what should empire/i,
      /empire report/i,
      /executive report/i,
    ],
  },

/** T5-08 — Automatic Executive Workspace Intelligence recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ExecutiveWorkspaceIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendWorkspaceLog({
      event: "workspace_intelligence_failure",
      level: "warn",

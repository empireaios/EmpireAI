/** R5-08 — Audience Intelligence recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: AudienceIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendAudLog({
      event: "audience_failures",
      level: "warn",
    ...
    appendAudLog({
      ...
      level: "info",
      details: `Audience Intelligence recovery attempt ${this.recoveryAttempts}`,
    });

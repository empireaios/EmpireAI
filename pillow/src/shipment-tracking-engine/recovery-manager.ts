/** R2-12 — Shipment tracking automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ShipmentTrackingEngineConfiguration): boolean {
    ...
    appendSteLog({
      ...
      level: "info",
      details: `Tracking recovery attempt ${this.recoveryAttempts}`,
    });

/** R2-05 — Supplier product sync automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SupplierProductSyncConfiguration): boolean {
    ...
    appendSpsLog({
      ...
      level: "info",
      details: `Supplier product sync recovery attempt ${this.recoveryAttempts}`,
    });

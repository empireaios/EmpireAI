/**
 * Integer-minor-unit money model for the Financial Reporting Worker (Q9-09).
...
function assertSameCurrency(a: MoneyMinor, b: MoneyMinor): void {
  if (a.currency !== b.currency) {
    throw new Error(
      `Financial Reporting Worker cannot combine mismatched currencies without conversion: ${a.currency} vs ${b.currency}`,
    );
  }
}

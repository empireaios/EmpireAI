/** X1-04 — Business Model Generator recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: BusinessModelGeneratorConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendBmgLog({
      event: "generation_failures",
      level: "warn",
    ...
    appendBmgLog({
      ...
      level: "info",
      details: `Business Model Generator recovery attempt ${this.recoveryAttempts}`,
    });

/** X1-05 — Brand Creation Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: BrandCreationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendBceLog({
      event: "brand_generation_failures",
      level: "warn",
    ...
    appendBceLog({
      ...
      level: "info",
      details: `Brand Creation Engine recovery attempt ${this.recoveryAttempts}`,
    });

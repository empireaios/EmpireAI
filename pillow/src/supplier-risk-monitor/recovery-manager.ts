/** R2-16 — Supplier risk monitor automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SupplierRiskMonitorConfiguration): boolean {
    ...
    appendSrmLog({
      ...
      level: "info",
      details: `Risk monitor recovery attempt ${this.recoveryAttempts}`,
    });

/** X3-12 — Automatic performance preservation recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: PerformancePreservationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendPpeLog({
      event: "preservation_failure",
      level: "warn",

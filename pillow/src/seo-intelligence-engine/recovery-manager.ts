/** R5-06 — SEO Intelligence recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SeoIntelligenceConfiguration): boolean {
    ...
    appendSieLog({
      ...
      level: "info",
      details: `SEO recovery attempt ${this.recoveryAttempts}`,
    });

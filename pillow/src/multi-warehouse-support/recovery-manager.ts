/** R2-15 — Multi-warehouse automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: MultiWarehouseSupportConfiguration): boolean {
    ...
    appendMwsLog({
      ...
      level: "info",
      details: `Network recovery attempt ${this.recoveryAttempts}`,
    });

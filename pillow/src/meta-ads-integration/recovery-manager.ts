/** R5-02 — Meta Ads recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: MetaAdsIntegrationConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendMaiLog({
      event: "meta_ads_failure",
      level: "warn",
    ...
    appendMaiLog({
      ...
      level: "info",
      details: `Meta Ads recovery attempt ${this.recoveryAttempts}`,
    });

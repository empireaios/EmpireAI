/** R4-17 — Customer Journey Intelligence recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CustomerJourneyIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendCjiLog({
      event: "journey_failure",
      level: "warn",

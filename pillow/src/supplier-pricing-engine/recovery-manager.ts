/** R2-07 — Supplier pricing automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SupplierPricingEngineConfiguration): boolean {
    ...
    appendSpeLog({
      ...
      level: "info",
      details: `Supplier pricing recovery attempt ${this.recoveryAttempts}`,
    });

/** R2-09 — Procurement automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ProcurementEngineConfiguration): boolean {
    ...
    appendPceLog({
      ...
      level: "info",
      details: `Procurement recovery attempt ${this.recoveryAttempts}`,
    });

/** R5-11 — Creative Asset Manager recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CreativeAssetManagerConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendCraLog({
      event: "asset_failures",
      level: "warn",
    ...
    appendCraLog({
      ...
      level: "info",
      details: `Creative Asset Manager recovery attempt ${this.recoveryAttempts}`,
    });

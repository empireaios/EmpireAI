/** R5-07 — Campaign Manager recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CampaignManagerConfiguration): boolean {
    ...
    appendCamLog({
      ...
      level: "info",
      details: `Campaign Manager recovery attempt ${this.recoveryAttempts}`,
    });

/** X2-12 — Automatic shared customer intelligence recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SharedCustomerIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSciLog({
      event: "customer_intelligence_failure",
      level: "warn",

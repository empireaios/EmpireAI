/** X3-18 — Automatic scale simulation engine recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ScaleSimulationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSsiLog({
      event: "scale_simulation_failure",
      level: "warn",

/** X4-13 — Automatic global talent intelligence recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: GlobalTalentIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendTalLog({
      event: "workforce_intelligence_failure",
      level: "warn",

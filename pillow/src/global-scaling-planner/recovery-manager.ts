/** X3-14 — Automatic global scaling planner recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: GlobalScalingPlannerConfiguration): boolean {

    this.consecutiveFailures += 1;

    appendGspLog({

      event: "global_scaling_failure",

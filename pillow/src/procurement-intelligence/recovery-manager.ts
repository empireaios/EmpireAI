/** R2-19 — Procurement intelligence automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ProcurementIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendPiLog({
      event: "intelligence_failure",
      level: "warn",
    ...
    appendPiLog({
      ...
      level: "info",
      details: `Procurement intelligence recovery attempt ${this.recoveryAttempts}`,
    });

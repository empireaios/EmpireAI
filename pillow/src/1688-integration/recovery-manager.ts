/** R2-04 — 1688 connector automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: Oss1688IntegrationConfiguration): boolean {
    ...
    appendOssLog({
      ...
      level: "info",
      details: `1688 recovery attempt ${this.recoveryAttempts}`,
    });

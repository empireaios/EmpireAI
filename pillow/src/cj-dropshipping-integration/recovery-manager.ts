/** R2-02 — CJdropshipping connector automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CjDropshippingIntegrationConfiguration): boolean {
    ...
    appendCjLog({
      ...
      level: "info",
      details: `CJdropshipping recovery attempt ${this.recoveryAttempts}`,
    });

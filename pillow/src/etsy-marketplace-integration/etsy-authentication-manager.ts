/** R1-07 — Etsy Open API authentication manager (OAuth abstraction). */

import { appendEtsyLog } from "./etsy-logging.js";
import type { EtsyMarketplaceIntegrationConfiguration } from "./configuration.js";
import type { EtsyAuthResult } from "./types.js";

export class EtsyAuthenticationManager {
  ...
  authenticate(
    ...
    appendEtsyLog({
      ...
      level: "info",
      details: "Etsy OAuth authentication",
    });
    ...
    return {
      ...
      details: authenticated
        ...
        : "Missing Etsy credential reference",
    };
  }

/** X1-07 — Store Generation Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: StoreGenerationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSgeLog({
      event: "storefront_failures",
      level: "warn",
    ...
    appendSgeLog({
      ...
      level: "info",
      details: `Store Generation Engine recovery attempt ${this.recoveryAttempts}`,
    });

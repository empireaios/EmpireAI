/** X4-07 — Automatic global tax intelligence recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: GlobalTaxIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendGtiLog({
      event: "tax_intelligence_failure",
      level: "warn",

/** R5-17 — Marketing Experiment Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: MarketingExperimentEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendMeeLog({
      event: "experiment_failures",
      level: "warn",
    ...
    appendMeeLog({
      ...
      level: "info",
      details: `Marketing Experiment Engine recovery attempt ${this.recoveryAttempts}`,
    });

/** R2-08 — Supplier ranking automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SupplierRankingEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSreLog({
      event: "ranking_failure",
      level: "warn",
    ...
    appendSreLog({
      ...
      level: "info",
      details: `Supplier ranking recovery attempt ${this.recoveryAttempts}`,
    });

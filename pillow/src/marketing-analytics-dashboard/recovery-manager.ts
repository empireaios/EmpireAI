/** R5-10 — Marketing Analytics Dashboard recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: MarketingAnalyticsDashboardConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendMadLog({
      event: "dashboard_failures",
      level: "warn",
    ...
    appendMadLog({
      ...
      level: "info",
      details: `Marketing Analytics Dashboard recovery attempt ${this.recoveryAttempts}`,
    });

/** R4-16 — Customer Segmentation Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CustomerSegmentationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendCsegLog({
      event: "segmentation_failure",
      level: "warn",

/** R2-17 — Logistics optimization automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: LogisticsOptimizationConfiguration): boolean {
    ...
    appendLoLog({
      ...
      level: "info",
      details: `Logistics recovery attempt ${this.recoveryAttempts}`,
    });

...
import type { ApiProviderRegistration, ApirtInput, AuthMethod } from "./types.js";
...
export class AuthManager {
   ...
   */
  authenticate(provider: ApiProviderRegistration, input: ApirtInput = {}): AuthResult {
    const method = input.authMethod ?? provider.authMethod;
    const credentialReference = input.credentialReference ?? provider.credentialReference;

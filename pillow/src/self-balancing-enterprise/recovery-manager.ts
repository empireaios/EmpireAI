/** X3-19 — Automatic self-balancing enterprise recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SelfBalancingEnterpriseConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSbeLog({
      event: "self_balancing_failure",
      level: "warn",

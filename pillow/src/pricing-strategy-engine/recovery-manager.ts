/** X1-09 — Pricing Strategy Engine recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: PricingStrategyEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendPseLog({
      event: "pricing_failures",
      level: "warn",
    ...
    appendPseLog({
      ...
      level: "info",
      details: `Pricing Strategy Engine recovery attempt ${this.recoveryAttempts}`,
    });

/** X2-11 — Automatic cross-company resource recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: CrossCompanyResourceEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendCcreLog({
      event: "resource_failure",
      level: "warn",

/** R4-18 — Executive Customer Dashboard recovery manager. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ExecutiveCustomerDashboardConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendEcdLog({
      event: "dashboard_failure",
      level: "warn",

/** R2-13 — Return management automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: ReturnManagementConfiguration): boolean {
    ...
    appendRmLog({
      ...
      level: "info",
      details: `Return recovery attempt ${this.recoveryAttempts}`,
    });

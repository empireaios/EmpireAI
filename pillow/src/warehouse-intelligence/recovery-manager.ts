/** R2-14 — Warehouse intelligence automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: WarehouseIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendWiLog({
      event: "warehouse_failure",
      level: "warn",
    ...
    appendWiLog({
      ...
      level: "info",
      details: `Warehouse recovery attempt ${this.recoveryAttempts}`,
    });

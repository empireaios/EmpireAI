/** X2-15 — Automatic acquisition evaluation recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: AcquisitionEvaluationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendAeeLog({
      event: "acquisition_evaluation_failure",
      level: "warn",

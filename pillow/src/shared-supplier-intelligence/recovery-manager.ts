/** X2-13 — Automatic shared supplier intelligence recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: SharedSupplierIntelligenceConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendSsiLog({
      event: "supplier_intelligence_failure",
      level: "warn",

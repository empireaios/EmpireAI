 ...
 * workers — never invented. The Worker Registry is the sole authoritative
 * source; Pillow Command Audit never fabricates or assumes additional
 * workers. Pillow can discover every registered worker.
 */

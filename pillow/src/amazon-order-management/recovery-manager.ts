/** R1-04 — Amazon order management automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: AmazonOrderManagementConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendOrderLog({
      event: "order_sync_failure",
      level: "warn",
    ...
    appendOrderLog({
      ...
      level: "info",
      details: `Amazon order sync recovery attempt ${this.recoveryAttempts}`,
    });

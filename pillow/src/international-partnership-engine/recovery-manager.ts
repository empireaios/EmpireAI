/** X4-12 — Automatic international partnership recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: InternationalPartnershipEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendIpeLog({
      event: "partnership_failure",
      level: "warn",

/** R2-10 — Fulfilment automatic recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: FulfilmentOrchestratorConfiguration): boolean {
    ...
    appendFoLog({
      ...
      level: "info",
      details: `Fulfilment recovery attempt ${this.recoveryAttempts}`,
    });

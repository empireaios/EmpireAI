/** X3-16 — Automatic revenue acceleration engine recovery. */
...
export class RecoveryManager {
  ...
  recordFailure(error: string, config: RevenueAccelerationEngineConfiguration): boolean {
    this.consecutiveFailures += 1;
    appendRaeLog({
      event: "revenue_acceleration_failure",
      level: "warn",

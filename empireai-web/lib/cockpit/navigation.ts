...
export const cockpitNavigation = [
  ...
  },
  {
    ...
    href: `${COCKPIT_BASE}/relationship`,
    screenId: "SCR-015",
    icon: "graph",
    department: "executive",
    navLevel: "primary",
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        id: "markets",
        label: "Markets",
        href: `${COCKPIT_BASE}/intelligence/markets`,
        screenId: "SCR-104",
        department: "intelligence",
        navLevel: "tab",
      },
      {
        id: "customers",
        label: "Customers",
        href: `${COCKPIT_BASE}/intelligence/customers`,
        screenId: "SCR-107",
        department: "intelligence",
        navLevel: "tab",
      },
      {
        id: "risk",
        label: "Risk",
        href: `${COCKPIT_BASE}/intelligence/risk`,
        screenId: "SCR-108",
        department: "intelligence",
        navLevel: "tab",
      },
      {
        id: "decisions",
        label: "Decisions",
        href: `${COCKPIT_BASE}/intelligence/decisions`,
        screenId: "SCR-109",
        department: "intelligence",
        navLevel: "tab",
      },
      {
        id: "executive",
        label: "Executive",
        href: `${COCKPIT_BASE}/intelligence/executive`,
        screenId: "SCR-110",
        department: "intelligence",
        navLevel: "tab",
      },
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        id: "ad-intelligence",
        label: "Ad Intel",
        href: `${COCKPIT_BASE}/commerce/ad-intelligence`,
        screenId: "SCR-106",
        department: "commerce",
        navLevel: "tab",
      },
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        id: "automation",
        label: "Automation",
        href: `${COCKPIT_BASE}/operations/automation`,
        screenId: "SCR-303",
        department: "operations",
        navLevel: "tab",
      },
      {
        ...
        href: `${COCKPIT_BASE}/operations/authorizations`,
        screenId: "SCR-304",
        department: "operations",
        navLevel: "tab",
      },
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        href: `${COCKPIT_BASE}/finance/intelligence`,
        screenId: "SCR-105",
        department: "finance",
        navLevel: "tab",
      },

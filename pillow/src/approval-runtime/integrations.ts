...
export class ApvrtIntegrationCoordinator {
  private deps: ApprovalRuntimeDependencies = {};

  bind(deps: ApprovalRuntimeDependencies = {}) {
  ...
  getQ1009ConsumableContract() {
    return this.deps.communicationRuntime?.getQ1009ConsumableContract?.() ?? null;
  }

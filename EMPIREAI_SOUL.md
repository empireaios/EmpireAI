...
```mermaid
flowchart TB
    GK[Grand King<br/>Sovereign · Soul Owner]
    CA[Chief Architect<br/>Co-maintainer]
    PIL[Pillow COI<br/>Soul Steward]

    VIS[EMPIREAI_VISION.md<br/>WHY · Tier 2]
    SOUL[EMPIREAI_SOUL.md<br/>WHO · Memory · Tier 2]
    CTD[CTD + Constitutions<br/>Law · Tier 3]
    ROAD[Roadmaps · CON Lock<br/>WHAT · Tier 4]
    ARCH[Canonical Architecture<br/>HOW · Tier 5]
    DOC[ECDS Documentation<br/>Navigation · Evidence]
    PROD[Production · STATUS<br/>Live Truth · Operational]

    BRAIN[Brain<br/>Reads Soul · Executes]
    BUILD[Builder / Cursor<br/>Syncs Soul · Implements]
    COCK[Cockpit<br/>Visualizes · No Soul Write]
    ...
    BRAIN --> COCK
    PROD --> COCK
    PROD -.->|operational only| SOUL

    ACC[Vision Accumulation P1-03] --> VIS
    ACC --> SOUL
```

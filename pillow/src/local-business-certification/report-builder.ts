...
import { LBC_METADATA_VERSION, LOCAL_BUSINESS_CERTIFICATION_REPORT_VERSION } from "./paths.js";
import type {
  AuditStatus,
...
export function buildDeliverableVerification(
  ...
  return {
    verificationId: `lbc-ver-${Date.now()}`,
...
export function buildReport(params: BuildReportParams): LocalBusinessCertificationReport {
  ...
  return {
    ...
    certificationScope: Q7_MISSIONS.map((m) => m.missionId),
    ...
    reportVersion: LOCAL_BUSINESS_CERTIFICATION_REPORT_VERSION,
